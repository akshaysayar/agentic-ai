...
from research_tool_rag.rag.ingest_data import Node
from research_tool_rag.rag.model import llm_model as model
from research_tool_rag.rag.model import llm_tokenizer as tokenizer
...
class QdrantDB:
    ...
    def __init__(self, collection_name: str = "US_Laws"):
